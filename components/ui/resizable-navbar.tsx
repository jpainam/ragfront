  ...
  return (
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ? "rgba(34, 42, 53, 0.06) 0px 0px 24px, rgba(0, 0, 0, 0.05) 0px 1px 1px, rgba(34, 42, 53, 0.04) 0px 0px 0px 1px, rgba(34, 42, 53, 0.08) 0px 0px 4px, rgb(25, 255, 132, 0.1) 0px 16px 68px, rgba(25, 150, 99, 0.51) 0px 1px 0px inset"
          : "none",
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-gradient-to-b from-emerald-500 to-emerald-700 text-white shadow-[0px_5px_5px_0px_rgba(255,255,255,0.6)_inset]",
  };
