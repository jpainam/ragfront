...
import { BrainCircuitIcon, FileQuestionIcon, UploadCloud } from "lucide-react";
...
const features = [
  {
    ...
    content:
      "Upload your internals docs, policies, and urls using an unified interface.",
    icon: <UploadCloud className="text-primary h-6 w-6" />,
    image:
  ...
  },
  {
    ...
    content:
      "Build your documents index and connect it with your AI assistant. Customize the AI's behavior and responses.",
    icon: <BrainCircuitIcon className="text-primary h-6 w-6" />,
    image:
  ...
  },
  {
    ...
    title: "Query with AI",
    content:
      "Ask questions to your AI assistant and get answers sourced directly from your internal documentation.",
    icon: <FileQuestionIcon className="text-primary h-6 w-6" />,
    image:
        ...
        <div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
          <div className="relative z-10">
            ...
            <p className="font-geist text-foreground/60 mt-3">
              A simple 3-step process to get started with your AI assistant.
            </p>
          </div>
          <div
